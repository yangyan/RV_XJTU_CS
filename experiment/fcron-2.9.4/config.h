 ...
 */
 ...
 /* $Id: config.h.in,v 1.51 2003/12/29 17:06:16 thib Exp thib $ */
...
#define VERSION_QUOTED "2.9.4"

#define CFLAGS "-O2 -Wall"

/* *** paths *** */
#define ETC "/etc"
#define SBINDIREX "/usr/sbin"
#define BINDIREX "/usr/bin"
...
#define PIDFILE "/var/run/fcron.pid"
/* where is located fifo file ? */
#define FIFOFILE "/var/run/fcron.fifo"
